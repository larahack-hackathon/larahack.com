                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.events.store') }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control @error('event_type_id') is-invalid @enderror" name="event_type_id" id="event_type_id">
                                    ...
                                    @foreach($types as $type)
                                        <option value="{{ $type->id }}" @if(old('event_type_id') == $type->id) selected @endif>{{ $type->name }}</option>
                                    @endforeach
                                </select>
                                @error('event_type_id')
                            ...
                            <div class="form-group">
                                ...
                                <input type="datetime-local" class="form-control @error('voting_start_at') is-invalid @enderror" id="voting_start_at" name="voting_start_at" value="{{ old('voting_start_at') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('first_place_prize') is-invalid @enderror" id="first_place_prize" name="first_place_prize" value="{{ old('first_place_prize') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('second_place_prize') is-invalid @enderror" id="second_place_prize" name="second_place_prize" value="{{ old('second_place_prize') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('third_place_prize') is-invalid @enderror" id="third_place_prize" name="third_place_prize" value="{{ old('third_place_prize') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('runner_up_prize') is-invalid @enderror" id="runner_up_prize" name="runner_up_prize" value="{{ old('runner_up_prize') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('runner_up_amount') is-invalid @enderror" id="runner_up_amount" name="runner_up_amount" value="{{ old('runner_up_amount') }}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input @error('active') is-invalid @enderror" type="radio" name="active" id="active_yes" value="1" @if(old('active') === '1') checked @endif>
                                ...
                                <div class="form-check form-check-inline @error('active') is-invalid @enderror">
                                    <input class="form-check-input @error('active') is-invalid @enderror" type="radio" name="active" id="active_no" value="0" @if(old('active') === '0') checked @endif>
